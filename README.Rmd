...
This is a minimal example which shows how to use the package's functions to fill the internall precipitation timeseries and compute rainfall erosivity values.
