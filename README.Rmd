...
`hyetor` [@vantas2018] is an R  package [@CRAN] that provides a collection of tools that analyze fixed interval precipitation records. It can be used to:

 1. Aggregate precipitation values.
 2. Split precipitation time series to independent rainstorms using predifined monthly maximum dry period duration of no precipitation [@restitepo1982identification].
 ...
 6. Calculate rainfall erosivity values [@wischmeier1958rainfall, @brown1987storm and @McGregor1995].
